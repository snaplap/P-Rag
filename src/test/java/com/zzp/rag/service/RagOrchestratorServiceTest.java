...
class RagOrchestratorServiceTest {
    ...
    void shouldApplyRerankAfterHybridMerge() {
        ...
        RetrievalChunk kb1 = new RetrievalChunk("kb-1", "kb-doc-1", "知识库证据1", 0.92d, DataSourceType.KNOWLEDGE_BASE);
        RetrievalChunk kb2 = new RetrievalChunk("kb-2", "kb-doc-2", "知识库证据2", 0.71d, DataSourceType.KNOWLEDGE_BASE);
        RetrievalChunk webAsChunk = new RetrievalChunk("web-0", "WebDoc", "WebDoc。联网证据", 0.83d, DataSourceType.WEB);
